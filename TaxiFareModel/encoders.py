...
if __name__ == '__main__':
    ...
    print('testing TimeFeaturesEncoder')
    time_column = 'pickup_datetime'
    time_features_encoder = TimeFeaturesEncoder(time_column, time_zone_name='America/New_York')
    print(time_features_encoder.fit_transform(df))
    print('testing DistanceTransformer')
    distance_transformer = DistanceTransformer()
    print(distance_transformer.fit_transform(df))    
    print('end')